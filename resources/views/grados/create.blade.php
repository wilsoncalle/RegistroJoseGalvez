...
@section('title', 'Crear Grado - Sistema de Gestión Escolar')
            ...
            <form action="{{ route('grados.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('nombre') is-invalid @enderror" 
                               id="nombre" name="nombre" value="{{ old('nombre') }}" required placeholder="Ej: Primer Grado">
                        @error('nombre')
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('nivel_id') is-invalid @enderror" 
                            ...
                            @foreach($niveles as $nivel)
                                <option value="{{ $nivel->id_nivel }}" {{ old('nivel_id') == $nivel->id_nivel ? 'selected' : '' }}>
                                    {{ $nivel->nombre }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save me-1"></i> Guardar Grado
                    </button>
                </div>
            </form>
        </div>
