    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                <li>
                    <a class="dropdown-item text-success" href="{{ route('asignaciones.export', request()->query()) }}">
                        <i class="bi bi-file-earmark-excel me-1"></i> Exportar a Excel
                    </a>
                </li>
                <li>
                    <a class="dropdown-item text-danger" href="{{ route('asignaciones.pdf', request()->query()) }}">
